...
const OPERATIONS_SECTIONS = [
  ...
  },
  {
    ...
    build: (settings: OperationsSettings) => (
      <LogSettingsSection
        defaultValues={{
          LogConsumeEnabled: settings.LogConsumeEnabled,
          LogRequestDetailEnabled: settings.LogRequestDetailEnabled,
          LogDetailCaptureRequestBody: settings.LogDetailCaptureRequestBody,
          LogDetailCaptureResponseBody: settings.LogDetailCaptureResponseBody,
          LogDetailCaptureHeaders: settings.LogDetailCaptureHeaders,
          LogDetailRetentionDays: settings.LogDetailRetentionDays,
          LogDetailMaxBodySizeKB: settings.LogDetailMaxBodySizeKB,
        }}
      />
    ),
  },
